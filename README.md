...
_Процесс генерации тестовых данных._
...
_Для начала необходимо создать папку data, которая будет организавана следующим образом:
...
_Для запуска просто нажмите run._
